  ...
  return (
    ...
    >
      <ServicesStack.Screen
        ...
        options={{ title: 'CleanPro • Servicios', headerShown: false }}
      />
      <ServicesStack.Screen
        name="ServiceDetail"
      ...
      <ServicesStack.Screen
        ...
        options={{ title: 'Nuevo Servicio', presentation: 'modal' }}
      />
    </ServicesStack.Navigator>
  );
}
...
export function RootNavigator(): React.JSX.Element {
  ...
  return (
    ...
    >
      <Tab.Screen name="Servicios" component={ServicesStackNavigator} options={{ tabBarLabel: 'Servicios' }} />
