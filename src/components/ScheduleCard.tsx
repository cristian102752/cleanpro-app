...
const statusColors: Record<Schedule['status'], { bg: string; color: string; label: string }> = {
  pendiente: { bg: '#fbbf2433', color: '#fbbf24', label: 'Pendiente' },
  en_curso: { bg: '#60a5fa33', color: '#60a5fa', label: 'En curso' },
  completado: { bg: '#34d39933', color: '#34d399', label: 'Completado' },
  cancelado: { bg: '#f8514933', color: '#f85149', label: 'Cancelado' },
};
