// THEME - CleanPro (Semana 01) - paleta dark con colores en TYPOGRAPHY
export const COLORS = {
  background: '#0d1117',
  surface: '#161b22',
  surfaceAlt: '#1c2128',
...
export const TYPOGRAPHY = {
  size: { xs: 11, sm: 13, base: 15, md: 17, lg: 20, xl: 24, xxl: 30 },
  weight: { regular: '400' as const, medium: '500' as const, semibold: '600' as const, bold: '700' as const },
  h1: { fontSize: 30, fontWeight: '700' as const, color: '#e6edf3' },
  ...
  caption: { fontSize: 13, fontWeight: '400' as const, color: '#8b949e' },
  label: { fontSize: 11, fontWeight: '600' as const, color: '#8b949e' },
} as const;
