...
// Semana 03 - detalle con params de navegación
...
const styles = StyleSheet.create({
  ...
  bookBtn: { backgroundColor: COLORS.accent, padding: SPACING.base, borderRadius: RADIUS.lg, alignItems: 'center', marginTop: SPACING.md },
