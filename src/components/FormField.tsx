...
// Semana 06 - campo reutilizable con Controller y error inline
      ...
      <Controller
        ...
        render={({ field: { onChange, value } }) => (
          <View style={styles.chipRow}>
            {options.map((opt) => (
              <Text key={opt} style={[styles.chip, value === opt && styles.chipActive]} onPress={() => onChange(opt)}>
...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.md, padding: SPACING.md, color: COLORS.textPrimary, fontSize: 15 },
  ...
  chip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: RADIUS.full, backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border },
